...
function Order() {
  ...
  return (
    <div className="space-y-8 px-4 py-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 rounded-xl bg-slate-200 px-6 py-5">
      ...
      <div className="space=y-2 rounded-xl bg-slate-200 px-6 py-5">
